...
export interface ApiLocalizationLocalization extends Schema.SingleType {
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.DynamicZone<['blocks.page-standart', 'blocks.page-blog']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    blocks: Attribute.DynamicZone<['blocks.banner']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
